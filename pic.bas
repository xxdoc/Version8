...
Case "KEYPRESS(", "LAN$", "LATIN", "LAYER", "LCASE$(", "LEFT$(", "LEFTPART$(", "LEGEND", "LEN"
...
Case "OVER", "OVERWRITE", "PAGE", "PARAGRAPH$(", "PARAGRAPH(", "PARAGRAPH.INDEX(", "PARAMETERS$", "PART", "PASSWORD"
Case "PATH", "PATH$(", "PAUSE", "PEN", "PI", "PIPE", "PIPENAME$(", "PLATFORM$", "PLAY"
Case "PLAYER", "PLAYSCORE", "POINT", "POINT(", "POLYGON", "POS", "POS.X", "POS.Y", "PRINT"
Case "PRINTER", "PRINTERNAME$", "PRINTING", "PROFILER", "PROPERTIES", "PROPERTIES$", "PUSH", "PUT", "QUOTE$("
...
Case "SPRITE$", "SQRT(", "STACK", "STACK$(", "STACK.SIZE", "STACKITEM$(", "STACKITEM(", "STACKTYPE$(", "START"
...
Case "деийтгса.у", "деийтгса.в", "деине", "дей(", "дейаен", "дейаен$(", "дем", "дени$(", "денилеяос$(", "дес"
...
Case "идиотгтес", "идиотгтес$", "исвмг", "исвмг$(", "ивмос", "йахаяг", "йахаяо", "йахе", "йаи", "йакесе", "йалпукг"
...
Case "кабг.амакоцийо.в(", "кабг.йатеухумсг(", "кахос", "кахос$", "кахос.таимиас$", "катимийа", "кенеис", "киста", "коц("
...
Case "нейима", "одгциа", "одгцос$(", "охомг", "олада", "олада.сумоко(", "омола", "омола.аявеиоу$("
Case "омола.аявеиоу.ломо$(", "омола.вягстг$", "ояио.амадяолгс", "ояисе", "ови", "паифеижымг", "паийтгс", "паине", "памта"
Case "памы", "памылисо(", "паяацяажос$(", "паяацяажос(", "паяахесг$(", "паяахуяо", "паяалетяои$", "паяе", "паяейаяе$"
...
Case "сеияа", "сеияиайос.дисйоу(", "секида", "семаяио", "сгл", "сгл(", "сглади", "сглеио", "сглеио(", "сглеяа"
