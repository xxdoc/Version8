...
IsNumber = False  ''         " " + & String$(w2 - Len(n$), " ")
 ...
 MyErMacro A$, "Unknown Property " & V$, "Άγνωστη ιδιότητα " & V$
 Else
MyErMacro A$, "Unknown Variable " & V$, "Άγνωστη μεταβλητή " & V$
End If
End If
Exit Function
...
itisavar:
                ...
                Else
                     ...
                     If w2 >= Len(A$) Then A$ = q$ + A$
                             ...
                             MyErMacro A$, "Unknown property  " & q$, "Άγνωστη ιδιότητα " & q$
                             Else
                                MyErMacro A$, "Unknown variable " & q$, "Άγνωστη μεταβλητή " & q$
...
PROCESSCOMMAND:
 ...
 MyEr "Unknown Property " & w$, "Άγνωστη ιδιότητα " & w$
 Else
MyEr "Unknown Variable " & w$, "Άγνωστη μεταβλητή " & w$
End If
...
End If
        ...
        If GetVar(bstack, w$, V) Then  'GetlocalVar(w$, V) Then
             ...
             End If
              GoTo again3
        Else
         MyEr "Unknown Weak " & w$, "Άγνωστη ισχνή " & w$
        End If
        End If
         If MaybeIsSymbol(b$, "=<") Then
            If FastSymbol(b$, "<=") Then
